...
(function ($) {
    ...
    //     const resWrap = document.querySelector('res');
    //     const resTrigger = document.getElementById('result');

    //     if (!(resWrap && resTrigger)) return;
    ...
    //         siteBody.classList.add('search-is-visible');
    //         setTimeout(function () {
    //             resWrap.querySelector('.search-field').focus();
    //         }, 100);
    //     });
    ...
    //             siteBody.classList.remove('search-is-visible');
    //             setTimeout(function () {
    //                 resWrap.querySelector('.search-field').blur();
    //             }, 100);
    //         }
    //     });
    ...
    //     resField.addEventListener('click', function (e) {
    //         e.stopPropagation();
    //     })

    //     resField.setAttribute('placeholder', 'Type Keywords');
    //     resField.setAttribute('autocomplete', 'off');
    // };
